         ...
         <div>
             <nav aria-label="breadcrumb">
                 <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">{{ __('messages.Types') }}</li>
                 </ol>
             </nav>
         </div>
     </div>
             ...
             <table id="messagesTable" class="table table-bordered table-hover">
                 ...
                 <tbody>
                     ...
                     <tr id="User-row-{{ $User->id }}">
                         ...
                         <td>
                             <a href="{{ route('admin.types.edit', $User->id) }}"
                             ...
                             <a href="javascript:void(0);"
                                 ...
                                 data-id="{{ $User->id }}"
                                 data-url="{{ route('admin.type.delete', $User->id) }}">
                                 Delete
                             </a>
                         </td>
                     </tr>
