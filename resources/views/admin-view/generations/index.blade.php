...
<div id="mainContent">
         ...
         <div>
             <nav aria-label="breadcrumb">
                 <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">{{ __('messages.Generations') }}</li>
                 </ol>
             </nav>
         </div>
     </div>
 ...
 <div class="content-body">
     ...
     <div class="component-section py-2 mt-0">
         ...
         <h4>
             {{ __('messages.Generations') }}
         </h4>
         <a href="{{ route('admin.generations.create') }}">

             <button class="btn btn-primary">
                 {{ __('messages.Create a Generation') }}
             </button>
         </a>
     </div>
             ...
             <table id="messagesTable" class="table table-bordered table-hover">
                 ...
                 <tbody>
                     ...
                     <tr id="User-row-{{ $User->id }}">
                         ...
                         <td>
                             <a href="{{ route('admin.generations.edit', $User->id) }}"
                             ...
                             <a href="javascript:void(0);"
                                 ...
                                 data-id="{{ $User->id }}"
                                 data-url="{{ route('admin.generations.delete', $User->id) }}">
                                 Delete
                             </a>
                         </td>
                     </tr>
                     ...
                     @else
                     <tr>
                         <td colspan="3" class="text-center">No Generation Found</td>
                     </tr>
                     @endif
                 </tbody>
             </table>
