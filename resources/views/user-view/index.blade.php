        ...
        <div class="row gx-0">
            ...
            <div class="col-12 col-xl-5 p-0">
                <div class="w-100 h-100 d-flex align-items-center justify-content-center"
                    ...
                    <!-- Optional: Overlay text or logo can go here -->
                </div>
            </div>

            <!-- Login Form -->
            <div class="col-12 col-xl-7 d-flex align-items-center justify-content-center p-4" style="min-height: 100vh;">
                    ...
                    <div class="card-body">
                        ...
                        <form id="loginForm">
                            ...
                            <div class="form-group icon-input mb-3 position-relative">
                                ...
                                <input type="text" class="style2-input ps-5 form-control" name="email" id="email"
                                    placeholder="{{ __('messages.Your Email Address') }}">
                            </div>

                            <div class="form-group icon-input mb-3 position-relative">
                                <i class="font-sm ti-lock text-grey-500 position-absolute top-50 translate-middle-y ps-3"></i>
                                <input type="password" class="style2-input ps-5 form-control" name="password" id="password"
                                    placeholder="{{ __('messages.Password') }}">
                            </div>

                            <div class="d-flex justify-content-end mb-3">
                                <a href="{{ route('password.request') }}"
                                    class="text-decoration-none fw-semibold text-muted">{{ __('messages.Forget Your Password') }}</a>
                            </div>

                            <div class="form-group mb-3">
                                <button type="submit" id="LoginBtn"
                                    class="btn btn-dark w-100 fw-semibold">{{ __('messages.Login') }}</button>
                            </div>

                            <div class="text-center">
                                <h6 class="text-muted fw-normal">{{ __('messages.Dont have account') }}
                                    <a href="register" class="fw-bold ms-1">{{ __('messages.Register') }}</a>
                                </h6>
                            </div>
                        </form>
                    </div>
